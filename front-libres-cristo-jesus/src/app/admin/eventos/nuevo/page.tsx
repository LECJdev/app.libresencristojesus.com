    ...
    setCampos(
      campos.map((c) => {
        if (c.id === id) {
          ...
          // Si se cambia el tipo a sublista, inicializar columnas
          if (field === 'tipo' && value === 'sublista') {
            updated.columnas = [{ nombre: '', tipo: 'texto' }];
          }
          // Si se cambia el tipo a opciones, inicializar opciones
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Crear Nuevo Evento</h1>
          <p className="text-slate-500">Define los detalles y los campos personalizados para la inscripción.</p>
        </div>
      </div>
